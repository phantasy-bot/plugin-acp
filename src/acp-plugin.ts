...
import { getACPService } from "./runtime/acp-service";
import { getACPOfferingRegistry } from "./runtime/offering-registry";
import { getAGDPTracker } from "./runtime/agdp-tracker";
import { getClawHubPublisher } from "./runtime/clawhub-publisher";
...
export class ACPPlugin extends BasePlugin {
  ...
  protected displayName = "ACP Commerce";
